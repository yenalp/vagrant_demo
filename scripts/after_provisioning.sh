...
echo -e "\e[34m\xE2\x84\xB9  INFO: \e[97m After scritp functionality ... "

# scripts
import.require 'provision.scripts'
import.useModule 'provision.scripts'  $1 $2

# permissions
import.require 'provision.permissions'
import.useModule 'provision.permissions' $1 $2

# Motd
import.require 'provision.motd'
import.useModule 'provision.motd' $1 $2
